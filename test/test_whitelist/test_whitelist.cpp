...
void test_add_and_contains() {
    TEST_ASSERT_FALSE(whitelist_contains("A4:BB:CC:DD:EE:FF"));
    whitelist_add("A4:BB:CC:DD:EE:FF");
    TEST_ASSERT_TRUE(whitelist_contains("A4:BB:CC:DD:EE:FF"));
}
...
void test_remove_existing() {
    whitelist_add("A4:BB:CC:DD:EE:FF");
    TEST_ASSERT_TRUE(whitelist_remove("A4:BB:CC:DD:EE:FF"));
    TEST_ASSERT_FALSE(whitelist_contains("A4:BB:CC:DD:EE:FF"));
}
...
void test_remove_middle_preserves_others() {
    whitelist_add("A4:BB:CC:DD:EE:01");
    whitelist_add("A4:BB:CC:DD:EE:02");
    whitelist_add("A4:BB:CC:DD:EE:03");

    whitelist_remove("A4:BB:CC:DD:EE:02");

    TEST_ASSERT_TRUE(whitelist_contains("A4:BB:CC:DD:EE:01"));
    TEST_ASSERT_FALSE(whitelist_contains("A4:BB:CC:DD:EE:02"));
    TEST_ASSERT_TRUE(whitelist_contains("A4:BB:CC:DD:EE:03"));
}
